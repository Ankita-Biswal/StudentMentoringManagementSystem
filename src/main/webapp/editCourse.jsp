...
<!-- End navbar -->
<h1 class="text-center text-success">Courses&Assignment Page</h1>
<% 
...
<input type="hidden" value=<%=t.getId()%> name="id">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="todo" value="<%=t.getTodo()%>">
  </div>
  <div class="form-group">
      <label for="inputState">SELECT COURSE</label>
      <select id="inputState" class="form-control" name="course" value="<%=t.getCourse()%>">
    ...
    <div class="form-group">
      <label for="inputState">ASSIGNMENT STATUS</label>
      <select id="inputState" class="form-control" name="assignment">
      <%
      if("Pending".equals(t.getAssignment())){
    	  %>
